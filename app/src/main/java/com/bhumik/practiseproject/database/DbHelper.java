package com.bhumik.practiseproject.database;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(Config.CREATE_TABLE_TEST);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + Config.TABLE_TEST);
        this.onCreate(db);
    }
    ...
    public void closeDatabase(SQLiteDatabase db, Cursor c) {
        ...
        // close(); Off does not improve efficiency
    }
