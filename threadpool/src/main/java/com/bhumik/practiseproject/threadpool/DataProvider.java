...
package com.bhumik.practiseproject.threadpool;
...
public class DataProvider extends ContentProvider {
     ...
     * {@link android.content.ContentResolver} that the {@link ContentProvider} has
     * been changed.
     *
     * @param uri               The content URI for the insertion
     * @param insertValuesArray A {@link ContentValues} array containing the row to
     *                          insert
